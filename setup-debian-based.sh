...
/home/${username}/.local/bin/wal -i ~/Pictures/Wallpapers/summer-sand-season.jpg
sleep 3
# Directory for building programs from source
...
sed -i "5s|.*|filepath=~/Pictures/Wallpapers/summer-sand-season.jpg|" ~/.local/bin/wallpaper-and-colors.sh
